...
public class FilesystemMapperImpl implements FilesystemMapper {
    private final TypeHandlerService typeHandlerService = new TypeHandlerServiceImpl();
    private final FilesystemMapperMounterFactory mounterFactory = FilesystemMapperMounterFactory.create();

    private final Map<Path, FilesystemMapperTargetImpl> targets = new HashMap<>();
